...
//BACKEND 
Route::get('/dashboard/about',[App\Http\Controllers\BackendController::class,'about'])->name('about.dashboard');

Route::get('/dashboard/about/create',[App\Http\Controllers\BackendController::class,'createabout'])->name('about.create');

Route::post('/post/about', [App\Http\Controllers\BackendController::class, 'prosestambahabout'])->name('about.add');
